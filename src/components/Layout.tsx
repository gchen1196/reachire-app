...
export function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className={`min-h-screen flex flex-col ${isHomePage ? 'bg-white' : 'bg-gray-50'}`}>
      <header className={`sticky top-0 z-10 bg-white ${isHomePage ? '' : 'border-b border-gray-200'}`}>
      ...
      <main className={`flex-1 ${isHomePage ? '' : 'container mx-auto px-4 sm:px-6 lg:px-8 py-6'}`}>
        {children}
      </main>
