  ...
  return (
    <div className="card p-4">
      <div className="flex items-start gap-3">
        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-primary-50 rounded-full flex items-center justify-center shrink-0">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mt-3 space-y-1.5">
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-gray-700 truncate leading-4">{contact.email}</span>
            </div>
            ...
            {contact.linkedinUrl && (
              ...
              >
                ...
                <span className="truncate leading-4">LinkedIn</span>
              </a>
            )}
          </div>
        </div>
      ...
      <div className="flex gap-2 mt-4">
        <button
          ...
          className="btn btn-accent btn-pill flex-1 py-2.5 px-3 text-sm gap-1.5"
        >
        ...
        <button
          ...
          className={`btn btn-pill flex-1 py-2.5 px-3 text-sm gap-1.5 ${
            contact.outreachStatus
              ? 'bg-accent-50 text-accent cursor-not-allowed'
